...
const ChatUi = () => {
    ...
    const { chatMessages, selectedChat, authToken } = useAppSelector(state => state.chat)
        ...
        <div> {selectedChat?.username ? <>
            ...
            <div className="position-relative">
                <div className="chat-messages p-4">
                    {chatMessages?.data?.map((msgdata: ChatMessageInterface) =>
                        <Messages
                            key={msgdata._id}
                    ...
                    <div>
                        <img src="https://bootdey.com/img/Content/avatar/avatar1.png" className="rounded-circle me-1" alt="Chris Wood" width="40" height="40" />
